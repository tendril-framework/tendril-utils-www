...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-utils-www',
    project_urls={
        'Documentation': 'https://tendril-utils-www.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-utils-www/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-utils-www',
    },
